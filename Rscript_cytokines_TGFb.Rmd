...
#Save results table
write.csv(sub_res_sig, file = "./Results TGFb/LogFoldChanges-sig_TGFb.csv", row.names = TRUE)
#Save results table
write.csv(sub_res_df, file = "./Results TGFb/LogFoldChanges_full_TGFb.csv", row.names = TRUE)
```
